/*
 * 개발 환경 CI/CD pipeline 등록 JOB DSL Script
 */

def jobFolderName = 'jenkins-pipeline-develop'

folder(jobFolderName) {
  displayName('[CI/CD Practice] 개발 CI/CD')
  description('개발 CI/CD Job Folder')
}

pipelineJob(jobFolderName + '/' + 'section-01') {
  displayName('1-00. ========== [ 개발 CI ] ==========')
  disabled()
}

pipelineJob(jobFolderName + '/' + 'section-02') {
  displayName('2-00. ========== [ 개발 CD ] ==========')
  disabled()
}
...
/**************************************************
 * section-01 ::: 개발 CI ::: START
 **************************************************/

/*
 * [ 개발 CI ]  pipeline No 1. ::: START
 */
[
  // 해당 pipeline Job 이름
  pipelineJobName  : jobFolderName + '/' + 'application-01-develop-ci' ,

  // 해당 pipeline Job 의 UI 출력명
  pipelineJobDisplayName  : '1-01. [ 개발 CI ] Application 이름' ,

  // 해당 pipeline Job description
  pipelineJobDescription  : '<br><h3>[ From ... ]</h3><h3>[ To ... ]</h3>' ,

  // DevOps Repository 내 해당 jenkinsfile 경로
  jenkinsfilePath  : "${JENKINSFILE_ROOT_PATH}/application-01/develop/ci",
  
  // DevOps Repository 내 해당 jenkinsfile 이름
  jenkinsfileName  : 'Jenkinsfile-application-01-develop-ci',
...
/*
 * [ 개발 CI ]  pipeline No 1. ::: END
 */

/**************************************************
 * section-01 ::: 개발 CI ::: END
 **************************************************/

/**************************************************
 * section-02 ::: 개발 CD ::: START
 **************************************************/

/*
 * [ 개발 CD ]  pipeline No 1. ::: START
 */

[
  // 해당 pipeline Job 이름
  pipelineJobName  : jobFolderName + '/' + 'application-01-develop-cd' ,

  // 해당 pipeline Job 의 UI 출력명
  pipelineJobDisplayName  : '2-01. [ 개발 CD ] Application 이름' ,

  // 해당 pipeline Job description
  pipelineJobDescription  : '<br><h3>[ From ... ]</h3><h3>[ To ... ]</h3>' ,

  // DevOps Repository 내 해당 jenkinsfile 경로
  jenkinsfilePath  : "${JENKINSFILE_ROOT_PATH}/application-01/develop/cd",
  
  // DevOps Repository 내 해당 jenkinsfile 이름
  jenkinsfileName  : 'Jenkinsfile-application-01-develop-cd',
...
/*
 * [ 개발 CD ]  pipeline No 1. ::: END
 */

/**************************************************
 * section-02 ::: 개발 CD ::: END
 **************************************************/
